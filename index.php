                                        ...
                                        <div class="row w-100 justify-content- center text-start">
                                            ...
                                            <div class="col-12 text-start justify-content-start">
                                                <il style="list-style: none">
                                                    <li style="font-weight: bold"> Università di Pisa, Pisa</li>
                                                    <li> Laureando in Ingegneria Informatica</li>
                                                    <li  style="font-weight: bold"> ITS Tullio Buzzi, Prato</li>
                                                    <li> 2020 - Diploma di Perito Informatico</li>
                                                </il>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card h-100 bg bg-success">
                                    <div class="card-body">
                                        ...
                                        <div class="row w-100 justify-content-center text-start">
                                            ...
                                            <div class="col-12 text-start justify-content-start">
                                                <il style="list-style: none">
                                                    <li> Programmatore e Sviluppatore Web </li>
                                                    <li> Docente presso l'ITS Tullio Buzzi nell'anno scolastico 2021/2022 </li>
                                                </il>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card h-100 bg bg-success">
                                    <div class="card-body">
                                        ...
                                        <div class="row w-100 justify-content-center text-start">
                                            ...
                                            <div class="col-12 text-start justify-content-start">
                                                <il style="list-style: none">
                                                    <li> Sviluppo Gestionali Web </li>
                                                    <li> Piattaforma Streaming 'Rivistaflix' C.d.P. </li>
                                                    <li> Portale Ripetizioni (Questo sito!) </li>
                                                </il>
                                            </div>
                                        </div>
                                    </div>
